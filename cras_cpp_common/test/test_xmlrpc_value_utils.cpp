...
TEST(XmlRpcValueUtils, ConvertArrays)
{
  ...
  if (std::numeric_limits<char>::is_signed)
    ...
    {TRACE; test_converts<std::vector<char>>(x, {0, 1}, true, true);}
  ...
  if (std::numeric_limits<char>::is_signed)
    ...
    {TRACE; test_converts<std::set<char>>(x, {0, 1}, true, true);}
  ...
  if (std::numeric_limits<char>::is_signed)
    ...
    {TRACE; test_converts<std::list<char>>(x, {0, 1}, true, true);}
  ...
  if (std::numeric_limits<char>::is_signed)
    ...
    {TRACE; test_converts<std::unordered_set<char>>(x, {0, 1}, true, true);}
