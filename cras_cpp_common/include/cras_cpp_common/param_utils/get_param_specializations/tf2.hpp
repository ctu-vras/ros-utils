...
DEFINE_CONVERTING_GET_PARAM(::tf2::Vector3, ::std::vector<double>, "",
    [](const ::std::vector<double>& v) {
      if (v.size() != 3) {
        throw ::std::runtime_error(::cras::format(
          "Cannot load tf2::Vector3 parameter from an array of length {}", v.size()));
      }
      return ::tf2::Vector3(v[0], v[1], v[2]);
    })

DEFINE_CONVERTING_GET_PARAM(::tf2::Quaternion, ::std::vector<double>, "",
    [](const ::std::vector<double>& v) {
      if (v.size() != 3 && v.size() != 4) {
        throw ::std::runtime_error(::cras::format(
          "Cannot load tf2::Quaternion parameter from an array of length {}", v.size()));
      }
      ::tf2::Quaternion m;
      if (v.size() == 4) {
...
DEFINE_CONVERTING_GET_PARAM(::tf2::Transform, ::std::vector<double>, "",
    [](const ::std::vector<double>& v) {
      if (v.size() != 6 && v.size() != 7 && v.size() != 16) {
        throw ::std::runtime_error(::cras::format(
          "Cannot load tf2::Transform parameter from an array of length {}", v.size()));
      }
      ::tf2::Transform m;
