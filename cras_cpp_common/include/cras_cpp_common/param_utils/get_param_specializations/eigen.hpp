...
/**
 * \file
 * \brief Specializations of getParam() for Eigen types.
 * \author Martin Pecka
 *
...
DEFINE_CONVERTING_GET_PARAM(::Eigen::Matrix4d, ::std::vector<double>, "",
    ([](const ::std::vector<double>& v) {
       impl::checkSize(v, 16, "4x4 matrix");
      ...
      switch (v.size()) {
        ...
        default:
          throw ::std::runtime_error(
            "Cannot construct Eigen isometry from " + ::std::to_string(v.size()) + " elements.");
      }
    })
